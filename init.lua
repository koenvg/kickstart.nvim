...
vim.keymap.set('n', '<C-P>', vim.cmd.cprevious, { desc = 'Go to the previous item in the Quickfix list' })
vim.keymap.set('n', '<C-N>', vim.cmd.cnext, { desc = 'Go to the next item in the Quickfix list' })
